...
export enum AboutActionType {
  ABOUT_DELETE_PROJECT = 'ABOUT_DELETE_PROJECT',
  ABOUT_FETCH_PROJECTS_LOADING = 'ABOUT_FETCH_PROJECTS_LOADING',
  ABOUT_FETCH_PROJECTS_SUCCESS = 'ABOUT_FETCH_PROJECTS_SUCCESS',
  ABOUT_FETCH_PROJECTS_FAILURE = 'ABOUT_FETCH_PROJECTS_FAILURE',
}
